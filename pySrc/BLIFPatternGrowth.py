...
def growASeqOfClusters_Old(BLIFGraph, clusterSeq, clusterNum, patternNum, paintPattern=False, featureLen=20):
        ...
        for cell in cluster.cellsContained:
            ...
            for inputNet in cell.inputNets:
                ...
                if (curNeighbor.clusterId != -1):
                    if (curNeighbor.cluster.clusterTypeId == cluster.clusterTypeId):
                        continue
                clusterNeighbors.append(curNeighbor)
                visitedNeighbors.add(curNeighbor)
                neighbor2cluster[curNeighbor] = cluster
                ...
                if (not neighborF in feature2Neighbors.keys()):
                    feature2Neighbors[neighborF] = []
                    feature2cnt[neighborF] = 0
                feature2Neighbors[neighborF].append(curNeighbor)
                feature2cnt[neighborF] += 1
                inOrderId += 1
            ...
            cluster2Neighbors.append(clusterNeighbors)
...
def growASeqOfClusters_BasedOn_old(BLIFGraph, clusterSeq, clusterNum, patternNum, paintPattern=False, featureLen=20, targetPatternTrace=""):
